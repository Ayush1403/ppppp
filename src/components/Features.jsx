...
const Features = ({projects}) => {
 ...
 <h1  ref={(el) => (titleRefs.current[index] = el)} className='text-2xl heading font-main uppercase absolute bottom-30 text-primary/10 tracking-wider text-[clamp(35vw,20vw,100vw)] font-black z-10'>{project.title}.{project.title}.{project.title}.</h1>
